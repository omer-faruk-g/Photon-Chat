  ...
  void _showDeactivatedDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Bu kişi hesabını bu cihazdan kaldırdı. Mesajın iletilemeyecek ve '
          'bu sohbete ait kayıtlar imha edilmiş durumda.',
          style: TextStyle(color: KnkColors.textDim, fontSize: 13, height: 1.6),
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text('Tamam', style: TextStyle(color: KnkColors.accent)),
          ),
        ],
      ),
    );
        ...
        children: [
          Container(
            ...
            decoration: const BoxDecoration(
              border: Border(bottom: BorderSide(color: KnkColors.line)),
            ),
            child: Row(
              children: [
                Container(width: 7, height: 7, decoration: const BoxDecoration(color: KnkColors.accent, shape: BoxShape.circle)),
                const SizedBox(width: 6),
                Text('FIP eşleşmesi · ${widget.contact.code}',
                    style: const TextStyle(color: KnkColors.textDim, fontSize: 10, letterSpacing: 1)),
              ],
            ),
          ),
          if (!_contactActive)
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      '${widget.contact.name} hesabını kaldırdı. Bu kişi artık aktif değil, '
                      'gönderdiğin mesajlar iletilmeyecek.',
                      style: const TextStyle(color: KnkColors.danger, fontSize: 11.5, height: 1.4),
                    ),
                  ),
                ],
              ),
            ...
            child: _messages.isEmpty
                ? const Center(
                    child: Padding(
                      ...
                      child: Text(
                        'Bu sohbet temiz. İlk mesajı sen gönder.',
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                _formatTime(m.ts),
                                style: TextStyle(
                                  color: (mine ? const Color(0xFF06251A) : KnkColors.text).withOpacity(0.6),
                                  fontSize: 9.5,
                                ),
                              ),
                            ],
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: _contactActive ? KnkColors.accent : KnkColors.line,
